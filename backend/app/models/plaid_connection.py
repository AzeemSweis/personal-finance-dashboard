...
class PlaidConnection(Base):
    ...
    sync_status = Column(String(50), default="pending", nullable=False)  # pending, success, error
    error_message = Column(Text, nullable=True)
    meta_data = Column(Text, nullable=True)  # JSON string for additional connection data
