...
class Transaction(Base):
    ...
    plaid_transaction_id = Column(String(255), unique=True, nullable=True)  # Plaid's transaction ID
    ...
    meta_data = Column(Text, nullable=True)  # JSON string for additional transaction data
